...
# can also use the softmax function to convert the output to a probability
# `dim=-1` argument specifies that the softmax should be computed along the last dimension of the input tensor.
