...
# Objective: To see the problem of initializing the weights with the same value.
# We will see that even for a simple network, our model will not train properly.
